...
describe('MongoHelper Sticky Note tests', () => {
    ...
    try {
      ...
      for (let i = 0; i < 10; ++i) {
        ...
        const data = {idx: rand_idx, author: rand_note.random_name(), content: rand_note.random_content(), type: 'snote', timestamp: rand_note.get_timestamp(), x: rand_note.random_x(), y: rand_note.random_y(), deleted: false, selected: false };
