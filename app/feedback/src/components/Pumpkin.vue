...
<template>
  <MainContent>
    ...
    <template v-slot:main-content>
      ...
      <div class="other">
        <span class="banner"> {{ pumpkin }} </span>
      </div>

      <textarea ref="ta">Wing of Bat</textarea>

      <!-- text box test -->
      <textarea name = "witch" rows="4" cols="">
        Eye of Newt
      </textarea>
      ...
      <div id="app">
        ...
        <div>
          ...
          <button v-on:click="Smash">Smash</button>
          <button v-on:click="Bold">Scary</button>
          <button v-on:click="Italics">Spooky</button>
      ...
      <div id="app">
        ...
        <!--<accordion title="Alucard">
          <p class="pb-5">frankenstein</p>

        </accordion>    
        <accordion title="Sypha Belnades">
          <p class="pb-5">werewolf</p>
...
<script lang="ts" src="./pumpkin.ts"></script>
